...
// Iconos SVG encapsulados como componentes funcionales para facilitar su uso con Tailwind.
// Se aceptan props de className para heredar estilos (color, tamaño).
